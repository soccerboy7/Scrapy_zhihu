...
ROBOTSTXT_OBEY = False #不执行机器协议，否则爬取的数据会有误
...
DEFAULT_REQUEST_HEADERS = {
  ...
  'authorization': 'oauth c3cef7c66a1843f8b3a9e6a1e3160e20' ,#设置OA ,它是Open Authorization的缩写。OAUTH_token:OAUTH进行到最后一步得到的一个“令牌”，通过此“令牌”请求，就可以去拥有资源的网站抓取任意有权限可以被抓取的资源。
